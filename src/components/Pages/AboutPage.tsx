...
function AboutPage() {
	return (
		<div className="flex flex-col min-h-screen">
			<Navbar />
			<main className="py-10 md:px-[7rem] flex-grow">
				<h1 className="text-4xl mb-5 mx-5">About Me</h1>
				<div className="flex flex-col md:flex-row justify-center items-center gap-3 md:gap-10">
					...
					<div className="about-info px-[30px] md:px-[10px] mt-5 text-lg text-[#233742]">
						<p className="mb-5">
